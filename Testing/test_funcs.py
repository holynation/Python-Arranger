...
class UnitTests(unittest.TestCase):
    def test_arrangement(self):
        ...
        self.assertEqual(actual, expected, 'Not the expected output when calling "arithmetic_arranger()" with ["3 + 855", "3801 - 2", "45 + 43", "123 + 49"]')

        actual = arithmetic_arranger(["11 + 4", "3801 - 2999", "1 + 2", "123 + 49", "1 - 9380"])
        expected = "  11      3801      1      123         1\n+  4    - 2999    + 2    +  49    - 9380\n----    ------    ---    -----    ------"
        self.assertEqual(actual, expected, 'Not the expected output when calling "arithmetic_arranger()" with ["11 + 4", "3801 - 2999", "1 + 2", "123 + 49", "1 - 9380"]')

    def test_many_problems(self):
        actual = arithmetic_arranger(["44 + 815", "909 - 2", "45 + 43", "123 + 49", "888 + 40", "653 + 87", "57 + 21", "21 + 11"])
        expected = "Error: Too many problems."
        self.assertEqual(actual, expected, 'Expected calling "arithmetic_arranger()" with more than seven problems to return "Error: Too many problems."')
    ...
    def test_many_digits(self):
        actual = arithmetic_arranger(["24 + 85215", "3801 - 2", "4555585 + 43", "123 + 49"])
        expected = "Error: Numbers cannot be more than six digits."
        self.assertEqual(actual, expected, 'Expected calling "arithmetic_arranger()" with a problem that has a number over six digits long to return "Error: Numbers cannot be more than four digits."')
